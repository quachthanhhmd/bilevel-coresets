...
class SplitFashionMnistImbalancedGenerator(DataGenerator):
    """FashionMNIST counterpart of ``SplitMnistImbalancedGenerator``, for the
    imbalanced-stream comparison of Sec. 5.4 / Table 6: the first 4 tasks are
    undersampled to 200 points, the last task keeps 2000 -- so a method that
    doesn't account for class imbalance (e.g. plain reservoir sampling)
